...
@section('content')
    <div class="page-header mb-4">
        <div>
            <h1 class="page-header-title">Edit Student</h1>
            <p class="page-header-subtitle">Update student information</p>
        </div>
    </div>
    ...
    <div class="card card-centered">
        ...
        <div class="card-body">
            ...
            <form action="/student/{{ $student->id }}" method="POST" id="editStudentForm" data-redirect="{{ url('/students') }}">
                @csrf
                @method('PUT')
                ...
                <div class="actions actions-center mt-4">
                    ...
                    <a href="{{ url('/student/' . $student->id) }}" class="btn btn-secondary btn-block">
